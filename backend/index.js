...
app.get('/allHoldings', async(req,res)=>{  //these are the api endpoints where we can connect the data to the dashboard
    let allHoldings = await HoldingsModel.find({});
    res.json(allHoldings);
})

app.get('/allPositions', async(req,res)=>{  //another api endpoint for position
