        ...
        <div className="container p-5">
            <div className="row p-5">
                <div className="col-6 p-5">
                    ...
                    <p className="text-muted">With initiatves like Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do better with your money</p>
                    
                </div>
                <div className="col-6 p-5">
                    <img src="media\images\ecosystem.png" alt="ecosystem  " style={{width:"100%"}}/>
                    <div className="text-center  ">
                        <a href="sdf" className="mx-5" style={{textDecoration:"none"}}>Explore our products<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <a href="sdfs" style={{textDecoration:"none"}}>Try kite demo<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
